...
## Devices in AAD (registered and joined)
...
## Self-Service Password Reset and FAQ
...
## Create users and members to groups in AAD in bulk
...
https://docs.microsoft.com/en-us/azure/active-directory/external-identities/code-samples?tabs=http
...
## Administrative unites in AAD
https://docs.microsoft.com/en-us/azure/active-directory/roles/administrative-units

## Azure RBAC and Management Groups
...
https://docs.microsoft.com/en-us/powershell/module/az.resources/new-aztag?view=azps-8.2.0&viewFallbackFrom=azps-3.6.1
## Cost Management
https://docs.microsoft.com/en-us/azure/cost-management-billing/cost-management-billing-overview

## Move Azure Resources to another RG or Subscription
