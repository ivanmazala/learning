...
## LB and VM availability and SLA
...
https://docs.microsoft.com/en-us/azure/virtual-machines/create-portal-availability-zone?tabs=standard
...
## PowerShell
https://docs.microsoft.com/en-us/powershell/module/az.compute/start-azvmssrollingosupgrade?view=azps-8.3.0&viewFallbackFrom=azps-3.6.1
https://docs.microsoft.com/en-us/powershell/module/az.compute/update-azvmssinstance?view=azps-8.3.0&viewFallbackFrom=azps-3.6.1
https://docs.microsoft.com/en-us/powershell/module/az.compute/update-azvmss?view=azps-8.3.0&viewFallbackFrom=azps-3.6.1
